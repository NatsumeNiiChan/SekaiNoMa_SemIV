...
public class Dialog_Text : MonoBehaviour
{
    ...
    public void Dialog_TakeruGeneral() /* Dialogue || 1 || */
    {
        ...
        /*p 1.1 = [0]*/ A_Dialog_Takeru_General[2]  = "»Oh, hello Takeru. So early today?« ";        
        ...
        /*t 1.6 = [5]*/ A_Dialog_Takeru_General[7]  = "»Dunno… Mine are nice, but they don't measure up to professional gardeners.« ";       
        ...
        /*p 1.4 = [3]*/ A_Dialog_Takeru_General[10] = "»Don't make that face. Tell me what i'm going to do for you today?« ";         
        /*t 1.7 = [6]*/ A_Dialog_Takeru_General[11] = "»I'd like Tonbara. To go please.« ";        
        /*p 1.8 = [7]*/ A_Dialog_Takeru_General[12] = "»Sure.« ";         
        /*t 1.1 = [0]*/ A_Dialog_Takeru_General[13] = "Player will now move on to cook.. ";       
    ...
    public void Dialog_TakeruCorrect() /* Dialogue || 1.Correct || */
    {
        ...
        /*t 1.6 = [5]*/ A_Dialog_Takeru_Correct[3]  = "»Actually quite well. I think i just applied too much.« ";
    ...
    public void Dialog_MamoruGeneral() /* Dialog || 2 || */
    {
        ...
        /*m 2.3 = [5]*/ A_Dialog_Mamoru_General[0] = "»Hello, my favorite chef!« ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_General[1] = "»Don't let this hear my colleagues.« ";
        /*m 2.2 = [4]*/ A_Dialog_Mamoru_General[2] = "Mamoru laughs. ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_General[3] = "»Tell me, how are you?« ";
        /*m 1.2 = [1]*/ A_Dialog_Mamoru_General[4] = "»Oh, better than ever. Everything is just fine right now.« ";
        /*p 1.1 = [0]*/ A_Dialog_Mamoru_General[5] = "»I'm glad.« You hesitate for a moment. »Tell me,can you do me a favor?« ";
        /*m 1.1 = [0]*/ A_Dialog_Mamoru_General[6] = "»Of course! What is it?« ";
        /*p 1.1 = [0]*/ A_Dialog_Mamoru_General[7] = "»You remember the little Yurei?« ";
        /*m 2.1 = [3]*/ A_Dialog_Mamoru_General[8] = "»Sure, how is she? Is she something still there?« ";
        /*p 2.1 = [3]*/ A_Dialog_Mamoru_General[9] = "»Yes, and I tried to talk to her. She said she was afraid of something, but didn't say what. Can you find out for me? As a Baku, you can see people's concerns. Is that also possible with Yurei?« ";
        /*m 2.1 = [3]*/ A_Dialog_Mamoru_General[10] = "»Hm… I don't know. But I can try it.« ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_General[11] = "»Oh, thank you! Say, what ramen do you want? Then I can get started.« ";
        /*m 2.3 = [5]*/ A_Dialog_Mamoru_General[12] = "»Oh, Kikaku please.« ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_General[13] = "»Of course.« ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_General[14] = "Player will now move on to cook.. ";
    ...
    public void Dialog_MamoruCorrect() /* Dialog || 2.Correct || */
    {
        ...
        /*m 2.1 = [3]*/ A_Dialog_Mamoru_Correct[3]  = "»Well, you'll have to ask her that yourself.« ";
        /*p 2.1 = [3]*/ A_Dialog_Mamoru_Correct[4]  = "»Thank you, Mamoru. Maybe I can help her somehow.« ";
        /*m 2.3 = [5]*/ A_Dialog_Mamoru_Correct[5]  = "»I am sure of that. You've got a knack for it.« ";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_Correct[6]  = "»How is it going with your Arashi?« ";
        /*m 2.2 = [4]*/ A_Dialog_Mamoru_Correct[7]  = "»I gave him my spare key now.« ";
        /*p 2.2 = [4]*/ A_Dialog_Mamoru_Correct[8]  = "»Uh, how romantic.« ";
        /*m 2.3 = [5]*/ A_Dialog_Mamoru_Correct[9]  = "»Not really, I have to buy everything twice. So now I have a toothbrush in every apartment.«";
        /*p 2.3 = [5]*/ A_Dialog_Mamoru_Correct[10] = "»Well, then you'll have to move in together.« ";
        /*m 2.1 = [3]*/ A_Dialog_Mamoru_Correct[11] = "»I don't know if we're ready for that yet... Even though we're actually always together.« ";
    ...
    public void Dialog_MamoruWrong() /* Dialog || 2.Wrong || */
    {
        ...
        /*m 2.1 = [3]*/ A_Dialog_Mamoru_Wrong[3] = "»Well, you'll have to ask her that yourself.« ";
        /*p 2.1 = [3]*/ A_Dialog_Mamoru_Wrong[4] = "»Thank you, Mamoru. Maybe I can help her somehow.« ";
        /*m 2.3 = [5]*/ A_Dialog_Mamoru_Wrong[5] = "»I am sure of that. You've got a knack for it. Í'll sit behind me, finding out a fear like that makes you hungry. « ";
    ...
    public void Dialog_NanamiGeneral() /* Dialog || 3. || */
    {
        ...
        /*p 2.3 = [8]*/  A_Dialog_Nanami_General[3] = "»Luckily, this is a restaurant. So, what do you want?« ";
        ...
        /*p 2.1 = [6]*/  A_Dialog_Nanami_General[7] = "»On the house. Come on, what do you want?« ";
        ...
        /*p 1.3 = [2]*/  A_Dialog_Nanami_General[11] = "»Okay, come right away.« ";
    ...
    public void Dialog_NanamiCorrect() /* Dialog || 3.Correct || */
    {
        ...
        /*p 2.1 = [6]*/  A_Dialog_Nanami_Correct[3] = "»Nanami? Everything OK?« ";
        ...
        /*n LEAVES   */  A_Dialog_Nanami_Correct[7] = "Nanami leaves to sit back in her seat and waits for us to play a game.  ";
    ...
    public void Dialog_NanamiWrong() /* Dialog || 3.Wrong || */
    {
        ...
        /*n LEAVES   */ A_Dialog_Nanami_Wrong[2] = "Nanami hesitates, but then leaves to sit back in her seatand waits for us to play a game. . ";
